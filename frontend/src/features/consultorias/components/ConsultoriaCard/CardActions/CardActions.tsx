...
export function CardActions({ consultancyId, clientName, isArchived, onArchive, onDelete, onUnarchive }: CardActionsProps) {
  ...
  return (
    <>
      <motion.div
        ...
        style={{ background: 'linear-gradient(to top, var(--bg-surface-2) 60%, transparent)' }}
      ...
      <DeleteConfirmDialog
        ...
        onConfirm={() => { setConfirmOpen(false); onDelete(consultancyId); }}
      />
    </>
  );
}
