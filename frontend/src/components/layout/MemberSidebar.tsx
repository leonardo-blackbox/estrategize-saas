...
export function MemberSidebar() {
  ...
  return (
    ...
    >
      {/* Brand */}
      <div className="flex h-14 items-center gap-2.5 px-5 border-b border-[var(--border-hairline)]">
      ...
      {/* Bottom section */}
      <div className="px-3 py-4 border-t border-[var(--border-hairline)] space-y-1">
        {isAdmin && (
          <NavLink
            to="/admin"
            className={({ isActive }) =>
        ...
        <div className="text-[10px] text-[var(--text-muted)] px-3 pt-1">
          Estrategize v1.0
        </div>
      </div>
    </aside>
