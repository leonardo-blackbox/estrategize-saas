...
const PROOFS = [
  {
    ...
    imageSrc: dep1,
    meta: 'Educadora',
    highlight: 'Primeira aluna: R$2.000 após a 1ª reunião',
    quote: '"Só com o seu direcionamento do primeiro encontro, fechei a primeira aluna cobrando 2k. Antes mesmo de receber a estrutura completa."',
    name: 'Valéria',
  },
  {
    id: 'thais-bessa',
    imageSrc: dep2,
    meta: 'Educadora',
    highlight: 'Duas turmas seguidas em 30 dias',
    quote: '"Fechei duas turmas seguidas em 30 dias de execução, garantindo dois meses de faturamento de uma vez. Desde então fecho turma todos os meses."',
    name: 'Thaís Bessa',
  },
  {
    id: 'raquel',
    imageSrc: dep3,
    meta: 'Educadora',
    highlight: 'Superou os 20 mil do mês anterior',
    quote: '"Mulher esse mês eu já fiz mais que o mês passado. Mês passado eu fechei com 20 mil."',
    name: 'Raquel',
  },
  {
    id: 'ana',
    imageSrc: dep4,
    meta: 'Educadora',
    highlight: 'Valeu mais que mentoria de R$20k',
    quote: '"Você sabe que eu participei de uma mentoria que me custou mais de 20 mil e não aprendi o que você me ensinou."',
    name: 'Ana Cláudia',
  },
  {
    id: 'jessika',
    imageSrc: dep5,
    meta: 'Educadora',
    highlight: 'Conteúdo totalmente diferente',
    quote: '"Hoje eu fiz o primeiro post baseado nos conteúdos estratégicos. É totalmente diferente fazer conteúdo assim, você realmente pensa no sentimento que quer gerar."',
    name: 'Jéssica F.',
  },
];
