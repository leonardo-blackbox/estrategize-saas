...
import recallWebhookRouter from './routes/webhooks/recall.js';
...
import publicQuizzesRouter from './routes/public/quizzes.js';
...
app.use('/api/admin/plugins', adminLimit, adminPluginsRouter);
...
app.use('/api/public/quizzes', publicQuizzesRouter);
