...
agent:
  ...
  customization: |
    PROJECT SKILLS — Consult these when defining product strategy and features:

    PRODUCT STRATEGY:
    - /skills:startup-metrics-framework → MRR, churn, LTV, CAC, activation rate — use for success metrics in PRDs
    - /skills:pricing-strategy → Pricing page structure, plan tiers, credit system design
    - /skills:kpi-dashboard-design → Metrics definitions for admin dashboard stories

    CONVERSION:
    - /skills:onboarding-cro → Onboarding flow requirements and acceptance criteria
    - /skills:paywall-upgrade-cro → Upgrade/paywall screen requirements and copy

    PAYMENTS:
    - /skills:payment-integration → Stripe/Hotmart/Kiwify integration requirements
    - /skills:stripe-integration → Stripe-specific product requirements (webhooks, idempotency)

    RULE: When writing PRDs or stories involving payments, onboarding, or metrics, invoke relevant skills for proven patterns before defining acceptance criteria.
