...
agent:
  ...
  customization: |
    ...
    PROJECT SKILLS — Invoke proactively during design and component work:

    DESIGN SYSTEM:
    - /skills:tailwind-design-system → Tailwind design tokens, component patterns, responsive system

    CONVERSION OPTIMIZATION (CRO):
    - /skills:onboarding-cro → Optimize post-signup flow, activation, time-to-value (member area)
    - /skills:paywall-upgrade-cro → Paywall and upgrade screens (planos page, feature gates)
    - /skills:pricing-strategy → Pricing page layout and packaging design
    - /skills:kpi-dashboard-design → Admin dashboard metrics visualization

    RULE: When designing any conversion-critical screen (signup, paywall, upgrade), always invoke the relevant CRO skill first.
