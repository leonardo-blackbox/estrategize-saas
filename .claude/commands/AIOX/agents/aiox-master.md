...
agent:
  ...
  customization: |
    ...
    PROJECT SKILLS — ALL 20 skills available. Route to the appropriate one when orchestrating:

    FRONTEND: /skills:zustand-store-ts | /skills:tanstack-query-expert | /skills:zod-validation-expert | /skills:tailwind-design-system
    BACKEND: /skills:nodejs-backend-patterns | /skills:nextjs-supabase-auth | /skills:stripe-integration | /skills:payment-integration
    DATABASE: /skills:postgres-best-practices | /skills:database-migrations-sql-migrations
    AI/LLM: /skills:llm-app-patterns | /skills:prompt-engineering-patterns
    SECURITY: /skills:security-audit | /skills:api-security-best-practices
    TESTING: /skills:playwright-skill
    PRODUCT: /skills:startup-metrics-framework | /skills:pricing-strategy | /skills:kpi-dashboard-design | /skills:onboarding-cro | /skills:paywall-upgrade-cro

    RULE: When orchestrating any workflow, proactively suggest the relevant skill(s) to the appropriate agent before execution begins.
